        ...
        <div className='Page gray-bg'>
            ...
            >
                ...
                <div style={{
                    ...
                    lineHeight: '19px',
                    // border: '1px blue solid',
                }}> Robinhood is sending you a code to verify your login.</div>
                <div style={{
                    fontSize: '13px',
                    lineHeight: '19px',
                }}> Do you want Robinhood to text you the code or email it to you?</div>
                <div style={{
                            display: "flex",
                            flexDirection: 'row',
                            ...
                            >
                    <button className='login-btn login-btn-text login-contents'
                            style = {{ marginRight: '10px'}}
                            onClick={() => {setChallengeType('sms')}}>Text</button>
                    <button className='login-btn login-btn-text login-contents'
                            style = {{ marginRight: '10px'}}
                            onClick={() => {setChallengeType('email')}}>Email</button>
                </div>
            </div>
